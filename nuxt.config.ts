...
export default defineNuxtConfig({
    ...
    head: {
      ...
      meta: [
        { name: 'X-UA-Compatible', content: 'IE=edge' },
        {
          name: 'keywords',
          content:
            'Giancarmelo pittala, giancarmelo, giancarmelo pittlà, giancarmelo pittalà web developer, web developer ita'
        },
        ...
        {
          name: 'og:image',
          content: `${DEFAULT_NUXT_PUBLIC_SITE_URL}/images/logo-bianco-261w.webp`
        },
        ...
        {
          name: 'og:description',
          content: 'Giancarmelo Pittalà, Web developer'
        }
      ],
      link: [
  ...
  modules: [
    '@pinia/nuxt', //https://v8.i18n.nuxtjs.org/getting-started/basic-usage
    '@nuxtjs/i18n', //https://icones.js.org/
    'nuxt-icon', //https://unhead-schema-org.harlanzw.com/guide/getting-started/how-it-works#runtime-inferences
    'nuxt-schema-org',
    'nuxt-simple-robots', //https://github.com/harlan-zw/nuxt-simple-sitemap
    // 'nuxt-simple-sitemap',
    '@nuxt/content',
    'nuxt-gtag',
    '@nuxthq/ui',
